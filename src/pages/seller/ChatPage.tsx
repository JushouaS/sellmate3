...
import { Search, Send, Phone, Image, Paperclip, ArrowLeft, Info, Clock, X } from "lucide-react";
              ...
              {selectedContact ? (
                ...
                <div className="flex-1 flex flex-col md:flex-row">
                  ...
                  <div className="w-full md:w-72 border-l border-green-100 bg-white p-6 flex flex-col items-center">
                    <Avatar className="h-32 w-32 mb-4 border-4 border-green-200 bg-gradient-to-br from-green-100 to-green-300">
                    ...
                    <h3 className="text-2xl font-bold text-center mb-1 text-green-800 tracking-tight">{sellerProfile.name}</h3>
            ...
            {selectedContact && (
              <div className="hidden lg:block w-72 border-l border-green-100 bg-white">
                <div className="p-6 flex flex-col items-center h-full">
                  ...
                  <p className="text-sm text-gray-500 mb-4">{sellerProfile.email}</p>
                  <Button 
                    className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold shadow-lg text-base py-3 rounded-lg mb-6"
                ...
                <Dialog open={showTransactionModal} onOpenChange={setShowTransactionModal}>
                  <DialogContent hideCloseButton className="max-w-md pt-4 pb-8 px-8 rounded-2xl shadow-2xl flex flex-col items-center bg-gradient-to-br from-green-50 to-green-100">
                    <div className="w-16 h-16 mb-2 mt-2 flex items-center justify-center rounded-full bg-gradient-to-r from-green-500 to-green-600 shadow-lg">
                      <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
                    <h2 className="text-2xl font-bold text-green-800 mb-3 mt-0">Transaction Details</h2>
                    <div className="w-full text-left space-y-2 mb-4 mt-0">
                      <div><span className="font-semibold text-green-700">Item:</span> iPhone 15 Pro</div>
                      <div><span className="font-semibold text-green-700">Buyer:</span> Maria Rodriguez</div>
                      <div><span className="font-semibold text-green-700">Middleman:</span> Joshua Oswald G. Santos</div>
                      <div><span className="font-semibold text-green-700">Price:</span> ₱85,000</div>
                      <div><span className="font-semibold text-green-700">Status:</span> Pending</div>
                      <div><span className="font-semibold text-green-700">Date:</span> Apr 12, 2025</div>
                      <div className="flex items-center gap-3 bg-green-50 border border-green-100 p-3 rounded-lg text-green-800 font-medium shadow-sm mt-4">
                        ...
                        <span className="truncate">{sellerProfile.phone}</span>
                      </div>
                      <div className="flex items-center gap-3 bg-green-50 border border-green-100 p-3 rounded-lg text-green-800 font-medium shadow-sm">
                        <svg className="w-5 h-5 text-green-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a2 2 0 01-2.828 0l-4.243-4.243a8 8 0 1111.314 0z" /><circle cx="12" cy="11" r="3" /></svg>
                        <span className="truncate">{sellerProfile.shopAddress}</span>
                      </div>
                    </div>
                    <Button className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-600 text-white font-semibold shadow text-base py-2 rounded-lg mt-2" onClick={() => setShowTransactionModal(false)}>
                      Close
                    </Button>
                  </DialogContent>
                </Dialog>
